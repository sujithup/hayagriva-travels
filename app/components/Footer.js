...
function Footer() {
  return (
    <div class="px-4 border-t-1 border-gray-100 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2">
          ...
          >
            <span class=" text-xl font-bold tracking-wide text-[#b82554] uppercase">
              Hayagriva
            </span>
          </a>
      ...
      <div class="flex flex-col-reverse justify-between pt-5  border-t lg:flex-row">
        <p class="text-sm text-gray-600">
          © Copyright {Date()} Hayagriva. All rights reserved.
        </p>
